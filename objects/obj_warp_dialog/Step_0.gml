...
if (dialog_active)
{
    ...
    if (mouse_check_button_released(mb_left))
    {
        ...
        var dialog_left   = x - sprite_get_width(spr_warp_dialog_board) / 2;
        var dialog_right  = x + sprite_get_width(spr_warp_dialog_board) / 2;
        var dialog_top    = y - sprite_get_height(spr_warp_dialog_board) / 2;
        var dialog_bottom = y + sprite_get_height(spr_warp_dialog_board) / 2;
